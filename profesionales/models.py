...
PERFIL = (
    (TATUADOR, 'Experto en Tattos'),
    (PIERCING, 'Experto en Piercing'),
...
class Profesional(TimeStampedModel):
    ...
    perfil = models.IntegerField(default=RECURSOS_HUMANOS, choices=PERFIL, db_index=True, null=True, blank=True)
    ...
    # Aceptacion expresa de:
    acepta_rgpd = models.BooleanField(default=False)
    acepta_mailing = models.BooleanField(default=False)
    acepta_sms = models.BooleanField(default=False)
    acepta_postal = models.BooleanField(default=False)
